...
def module_main(ctx):
    ...
    float_im_2 = a3.MultiDimImageFloat_to_ndarray(a3.inputs['intensity input 2'])
    a3dc_float_image_2 = Image(float_im_2, {'Name': 'random_name', 'Type': np.float})

    float_im_3 = a3.MultiDimImageFloat_to_ndarray(a3.inputs['intensity input 3'])
    a3dc_float_image_3 = Image(float_im_3, {'Name': 'random_name', 'Type': np.float})

    float_im_4 = a3.MultiDimImageFloat_to_ndarray(a3.inputs['intensity input 4'])
    a3dc_float_image_4 = Image(float_im_4, {'Name': 'random_name', 'Type': np.float})

    image_list = [a3dc_float_image_1, a3dc_float_image_2, a3dc_float_image_3, a3dc_float_image_4]
...
config = [a3.Input('tagged input', a3.types.ImageUInt32),
    ...
    a3.Input('intensity input 2', a3.types.ImageFloat),
    a3.Input('intensity input 3', a3.types.ImageFloat),
    a3.Input('intensity input 4', a3.types.ImageFloat),
