...
QtObject {
    ...
    readonly property string module_properties_change_request: "MODULE_PROPERTIES_CHANGE_REQUEST"
    readonly property string module_properties_changed_notification: "MODULE_PROPERTIES_CHANGED_NOTIFICATION"
